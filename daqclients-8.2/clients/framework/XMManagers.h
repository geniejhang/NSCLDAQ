...
class XMManager : public XMWidget {
 public:
  ...
  XMManager(const char *n) : XMWidget(n) {}
...
class XMBulletinBoard : public XMManager {
 ...
 public:
  ...
  XMBulletinBoard(const char *n) : XMManager(n) {}
...
class XMFrame : public XMManager {
 public:
  ...
  XMFrame(const char *name) : XMManager(name) {}
...
class XMForm : public XMBulletinBoard  {
 public:
  /* Constructors: */
  XMForm(const char *name) : XMBulletinBoard(name) {}
...
class XMRowColumn : public XMManager {
 public:
  ...
  XMRowColumn(const char *name) : XMManager(name) {}
...
class XMPanedWindow : public XMManager {
 public:
  /* Constructors: */
  XMPanedWindow(const char *name) : XMManager(name) {}
...
class XMMainWindow : public XMManager {
 public:
  XMMainWindow(const char *name) : XMManager(name) {}
