  ...
  : m_pMediator()
{
  ...
  unique_ptr<CDataSource> pSource( sourceFactory.makeSource("file://./testin8.evt", {}, {}) );

  CDataSinkFactory factory;
  unique_ptr<CDataSink> pSink( factory.makeSink("file://./testout8p10.evt") );

  setUpTransformFactory();

  m_pMediator = m_factory.create(8, 10);
