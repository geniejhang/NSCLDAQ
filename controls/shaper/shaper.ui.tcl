...
proc SaveConfiguration widget {
   ...
   set filename [tk_getSaveFile -defaultextension .shaper_values               \
                                            -title "Save $name configuration"  \
                                            -filetypes {                              \
					       {{Shaper Values}   {.shaper_values} }   \
					       {{All files}            {*} }}     ]
   if {$filename != "" }  {
...
#
#   Maintain the failsafe file $name_failsafe.shaper_values
#
proc MaintainFailsafe name {
	append filename $name _failsafe.shaper_values
	SaveFile $name $filename
...
proc RestoreSettings widget {
	...
	set filename [tk_getOpenFile -defaultextension .shaper_values               \
