...
#define CMDLINE_PARSER_PACKAGE "CCUSBReadout"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "CCUSBReadout"
#endif
...
struct gengetopt_args_info
{
  ...
  char * serialno_arg;	/**< @brief Serial number of CC-USB CCnnn.  */
  char * serialno_orig;	/**< @brief Serial number of CC-USB CCnnn original value given at command line.  */
  const char *serialno_help; /**< @brief Serial number of CC-USB CCnnn help description.  */
  ...
  const char *enumerate_help; /**< @brief Enumerate CC-USB modules and exit help description.  */
  ...
  char * init_script_arg;	/**< @brief Path to initialization script.  */
  char * init_script_orig;	/**< @brief Path to initialization script original value given at command line.  */
  const char *init_script_help; /**< @brief Path to initialization script help description.  */
  char * log_arg;	/**< @brief Log file path (enables logging)..  */
  char * log_orig;	/**< @brief Log file path (enables logging). original value given at command line.  */
  const char *log_help; /**< @brief Log file path (enables logging). help description.  */
  int debug_arg;	/**< @brief Logging verbosity (default='0').  */
  char * debug_orig;	/**< @brief Logging verbosity original value given at command line.  */
  const char *debug_help; /**< @brief Logging verbosity help description.  */
