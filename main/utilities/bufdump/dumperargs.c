/*
  ...
  /usr/bin/gengetopt --output-dir=. --file=dumperargs --unamed-opts=OPTIONS --set-version=11.4-028 
...
const char *gengetopt_args_info_purpose = "Formatted dump of acquired data items";

const char *gengetopt_args_info_usage = "Usage: Dumper [OPTIONS]... [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -w, --scaler-width=INT  Number of bits wide scaler counters are\n                            (default=`32')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->scaler_width_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->scaler_width_arg = 32;
  args_info->scaler_width_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->scaler_width_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->scaler_width_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->scaler_width_given)
    write_into_file(outfile, "scaler-width", args_info->scaler_width_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "sample",	1, NULL, 'S' },
        { "exclude",	1, NULL, 'e' },
        { "scaler-width",	1, NULL, 'w' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVs:m:c:S:e:w:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'e':	/* List of item types to exclude from the dump.  */
          ...
          break;
        case 'w':	/* Number of bits wide scaler counters are.  */
        
        
          if (update_arg( (void *)&(args_info->scaler_width_arg), 
               &(args_info->scaler_width_orig), &(args_info->scaler_width_given),
              &(local_args_info.scaler_width_given), optarg, 0, "32", ARG_INT,
              check_ambiguity, override, 0, 0,
              "scaler-width", 'w',
              additional_error))
            goto failure;
