...
#define CMDLINE_PARSER_PACKAGE "Dumper"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "Dumper"
#endif
...
struct gengetopt_args_info
{
  ...
  int scaler_width_arg;	/**< @brief Number of bits wide scaler counters are (default='32').  */
  char * scaler_width_orig;	/**< @brief Number of bits wide scaler counters are original value given at command line.  */
  const char *scaler_width_help; /**< @brief Number of bits wide scaler counters are help description.  */
  ...
  unsigned int scaler_width_given ;	/**< @brief Whether scaler-width was given.  */
