...
#include "CV11SourceCounterFilter.h"
#include <iostream>
#include <iomanip>
#include <sstream>
#include <fstream>
...
CRingItem* CSourceCounterFilter::handleAbnormalEndItem(CAbnormalEndItem *pItem)
{
    incrementCounter(pItem);
    return static_cast<CRingItem*>(pItem);
}

CRingItem* CSourceCounterFilter::handleDataFormatItem(CDataFormatItem *pItem)
{
    incrementCounter(pItem);
    return static_cast<CRingItem*>(pItem);
}
