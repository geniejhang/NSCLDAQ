...
/*!
 * \brief The CTransform11p0to11p0Tests_NonIncrScaler class
 *
 * Tests the validity of the transform of non-incr scaler items
 */
class CTransform11p0to11p0Tests_NonIncrScaler : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
    V11::CRingScalerItem       v11item;
    std::time_t time_now;

public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_NonIncrScaler);
...
public:
    CTransform11p0to11p0Tests_NonIncrScaler()
        : m_transform(),
    ...
    void setUp() {
        ...
        m_transform = CTransform11p0to11p0();
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_NonIncrScaler);
...
/*!
 * \brief The CTransform11p0to11p0Tests_IncrScaler class
 *
 * Tests the validity of transforms for incremental scaler items
 */
class CTransform11p0to11p0Tests_IncrScaler : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_IncrScaler);
    CPPUNIT_TEST(scaler_0);
    CPPUNIT_TEST(scaler_2);
    CPPUNIT_TEST(scaler_3);
    CPPUNIT_TEST(scaler_4);
...
public:
    CTransform11p0to11p0Tests_IncrScaler()
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_IncrScaler);
...
/*!
 * \brief The CTransform11p0to11p0Tests_State class
 *
 * Checks that state change items transform according to the rules
 */
class CTransform11p0to11p0Tests_State : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_State);
...
public:
    CTransform11p0to11p0Tests_State()
        : m_transform(), v10item(1), v11item(1), time_now() {}
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_State);
...
/*!
 * \brief The CTransform11p0to11p0Tests_PhysicsEvent class
 *
 *  Verifies that the rules are obeyed for physics event transforms
 */
class CTransform11p0to11p0Tests_PhysicsEvent : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_PhysicsEvent);
    CPPUNIT_TEST(physicsEvent_0);
    CPPUNIT_TEST(physicsEvent_1);
    CPPUNIT_TEST_SUITE_END();

public:
    CTransform11p0to11p0Tests_PhysicsEvent()
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_PhysicsEvent);
...
/*!
 * \brief The CTransform11p0to11p0Tests_EventCount class
 *
 *  Verifies that the rules of transformaton are obeyed for PHYSICS_EVENT_COUNT
 */
class CTransform11p0to11p0Tests_EventCount : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_EventCount);
...
public:
    CTransform11p0to11p0Tests_EventCount()
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_EventCount);
...
class CTransform11p0to11p0Tests_Fragment : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_Fragment);
...
public:
    CTransform11p0to11p0Tests_Fragment()
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_Fragment);
...
class CTransform11p0to11p0Tests_UnknownFragment : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_UnknownFragment);
...
public:
    CTransform11p0to11p0Tests_UnknownFragment()
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_UnknownFragment);
...
class CTransform11p0to11p0Tests_Text : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;
...
public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_Text);
    CPPUNIT_TEST(Text_0);
    CPPUNIT_TEST(Text_1);
    CPPUNIT_TEST(Text_2);
    CPPUNIT_TEST(Text_3);
...
public:
    CTransform11p0to11p0Tests_Text()
        : m_transform(),
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_Text);
...
class CTransform11p0to11p0Tests_General : public CppUnit::TestFixture
{
private:
    CTransform11p0to11p0       m_transform;

public:
    CPPUNIT_TEST_SUITE(CTransform11p0to11p0Tests_General);
    CPPUNIT_TEST(Test_0);
    CPPUNIT_TEST(Test_1);
    CPPUNIT_TEST_SUITE_END();
...
CPPUNIT_TEST_SUITE_REGISTRATION(CTransform11p0to11p0Tests_General);
