/*
  ...
  /usr/bin/gengetopt --file sclclientargs --output-dir=. 
...
const char *gengetopt_args_info_purpose = "Feed scaler data to scaler display program";

const char *gengetopt_args_info_usage = "Usage: SclClient [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --source=STRING  URL of the source ring buffer",
  "  -H, --host=STRING    Name of host in which TclServer is running",
  "  -p, --port=STRING    Port on which to connect to tclserver",
    0
};
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVs:H:p:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* URL of the source ring buffer.  */
          ...
          break;
        case 'H':	/* Name of host in which TclServer is running.  */
          ...
          break;
        case 'p':	/* Port on which to connect to tclserver.  */
