...
#ifndef NSCLDAQ_CONFIG_H
#define NSCLDAQ_CONFIG_H


/* Specifies that memory addresses are 64-bits */
#define ADDR64 1
...
/* Name of package */
#define PACKAGE "nscldaq"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "scientificsoftware@nscl.msu.edu"
