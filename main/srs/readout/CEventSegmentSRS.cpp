...
void CEventSegmentSRS::configure(std::string configFile, std::string daqPortStr, std::string mapStr)
{
    ...
    m_clientUdpThread = std::thread([&](int daqPort, std::string mapStr) {
        m_clientUdp->initialize(daqPort, mapStr);
