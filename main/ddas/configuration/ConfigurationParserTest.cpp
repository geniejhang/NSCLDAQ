...
class ConfigurationParserTest : public CppUnit::TestFixture
{
  ...
  public:
    ...
    void generate_0 () {
        std::string fwPath = TOP_SRC_DIR "/ddas/readout/DDASFirmwareVersions.txt.in";
        std::string cfgPath = TOP_SRC_DIR "/ddas/readout/crate_1/cfgPixie16.txt";
        std::string modEvtLenPath = TOP_SRC_DIR "/ddas/readout/crate_1/modevtlen.txt";
