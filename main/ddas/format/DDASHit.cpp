...
namespace DAQ {
	 ...
	 * @param channel  Slot value for this hit.
	 */
	void DDASHit::setSlot(uint32_t slot) { slotid = slot; }

	/**
	 * @brief Set the crate ID.
	 * @param channel  Crate ID value for this hit.
	 */
	void DDASHit::setCrate(uint32_t crate) {crateid = crate; }
	
	void DDASHit::setChannelHeaderLength(uint32_t channelHeaderLength)
	{ channelheaderlength = channelHeaderLength; }
	
	void DDASHit::setChannelLength(uint32_t channelLength)
	{ channellength = channelLength; }
	
	void DDASHit::setOverflowCode(uint32_t overflowBit)
	{ overflowcode = overflowBit; }
	
	void DDASHit::setFinishCode(bool finishCode)
	...
	void DDASHit::setCFDTrigSourceBit(uint32_t bit)
	...
	void DDASHit::setTimeHigh(uint32_t datum)
	...
	void DDASHit::setHardwareRevision(int value)
	{ m_hdwrRevision = value; }
	
	void DDASHit::appendEnergySum(uint32_t value)
	{ energySums.push_back(value); }
	
	void DDASHit::appendQDCSum(uint32_t value)
	{ qdcSums.push_back(value); }
	
	void DDASHit::appendTraceSample(uint16_t value)
	{ trace.push_back(value); }

	void DDASHit::setExternalTimestamp(uint64_t value)
	{ externalTimestamp = value; }
	
	void DDASHit::setADCOverflowUnderflow(bool state)
