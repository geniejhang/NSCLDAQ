/**
 * @file DDASBitMasks.h
 * @brief Define bit masks to extract data from specific locations of Pixie-16 
 * data.
 */
...
/** Bit 30 has overflow information (1 == overflow).*/
static const uint32_t OVERFLOWMASK      = 0x40000000;
/** Bit 31 has pileup information (1 == pileup). */
static const uint32_t FINISHCODEMASK    = 0x80000000; 
...
/** 
 * Number of words added to Pixie-16 channel event header when energy sums 
 * and baselines are recorded. 
 */
static const uint32_t SIZEOFESUMS = 4;
/** 
 * Number of words added to Pixie-16 channel event header when QDC sums are 
 * recorded. 
 */
