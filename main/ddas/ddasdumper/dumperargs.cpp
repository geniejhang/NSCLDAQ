/*
  ...
  /usr/bin/gengetopt --input=../../../ddas/ddasdumper/dumperargs.ggo --file-name dumperargs --output-dir=../../../ddas/ddasdumper 
...
const char *gengetopt_args_info_purpose = "Formatted dump of selected data items and conversion of ddas PHYSICS_EVENTS to\nroot trees.";

const char *gengetopt_args_info_usage = "Usage: ddasdumper [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -S, --sample=STRING   *Deprecated* List of item types to sample",
  "  -e, --exclude=STRING  List of item types to exclude from the dump",
  "  -f, --fileout=STRING  Path of output file",
  "  -l, --legacy-mode     *Deprecated* use --format* Legacy data format enabled.\n                          This is not a default setting  (default=off)",
  "  -F, --format=ENUM     Format of input data - replaces the legacy-mode flag\n                          (possible values=\"v12\", \"v11\", \"v10\"\n                          default=`v12')",
    0
};
...
const char *cmdline_parser_format_values[] = {"v12", "v11", "v10", 0}; /*< Possible values for format. */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->legacy_mode_flag = 0;
  args_info->format_arg = format_arg_v12;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->skip_help = gengetopt_args_info_help[3] ;
  args_info->count_help = gengetopt_args_info_help[4] ;
  args_info->sample_help = gengetopt_args_info_help[5] ;
  args_info->exclude_help = gengetopt_args_info_help[6] ;
  args_info->fileout_help = gengetopt_args_info_help[7] ;
  args_info->legacy_mode_help = gengetopt_args_info_help[8] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->legacy_mode_given)
    write_into_file(outfile, "legacy-mode", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->fileout_given)
    {
      fprintf (stderr, "%s: '--fileout' ('-f') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "exclude",	1, NULL, 'e' },
        { "fileout",	1, NULL, 'f' },
        { "legacy-mode",	0, NULL, 'l' },
        { "format",	1, NULL, 'F' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVs:m:c:S:e:f:lF:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* URL of source, ring buffer or file.  */
        ...
        case 'm':	/* number of items to skip before dumping.  */
          ...
          break;
        case 'c':	/* Number of items to dump before exiting.  */
          ...
          break;
        case 'S':	/* *Deprecated* List of item types to sample.  */
          ...
          break;
        case 'e':	/* List of item types to exclude from the dump.  */
        ...
        case 'f':	/* Path of output file.  */
          ...
          break;
        case 'l':	/* *Deprecated* use --format* Legacy data format enabled. This is not a default setting.  */
        
        
          if (update_arg((void *)&(args_info->legacy_mode_flag), 0, &(args_info->legacy_mode_given),
              &(local_args_info.legacy_mode_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "legacy-mode", 'l',
              additional_error))
            goto failure;
        
          break;
        case 'F':	/* Format of input data - replaces the legacy-mode flag.  */
        
        
          if (update_arg( (void *)&(args_info->format_arg), 
               &(args_info->format_orig), &(args_info->format_given),
              &(local_args_info.format_given), optarg, cmdline_parser_format_values, "v12", ARG_ENUM,
              check_ambiguity, override, 0, 0,
              "format", 'F',
              additional_error))
            goto failure;
