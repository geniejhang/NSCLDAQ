...
/*==============================================================*/
/** @fn CADC2530::readBufferBlock(unsigned int* pDest,unsigned int nLongs)
* @brief Utility to read a block of data.
*
* Utlitiy to read a block of data from list mode memory.
* This is mainly here to optimize non mapped VME interfaces.
*
* @param pDest Pointer to the memory where read data will be stored.
* @param pLongs Number of longs to read.
* @return None.
*/                                                             
/*
