...
class XMMessageBox : public XMManagedWidget
		   ...
		   public:
		     ...
		     XMMessageBox(const char *n) : XMManagedWidget(n) {}
		     XMMessageBox(const Widget w) : XMManagedWidget(w)
		       {
			 GetButtons(); 
		       }
		     /* Get Button Widgets: */
...
class XMErrorDialog : public XMMessageBox
		   ...
		   public:
		     /*  Constructors: */
		     XMErrorDialog(const char *n, Widget parent, const char *msg,
				   void (*cb)(XMWidget *,
		     ...
		     XMErrorDialog(const char *n, XMWidget &parent, const char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount = 0):
...
class XMInformationDialog : public XMMessageBox
{
 public:
  /*  Constructors: */
  XMInformationDialog(const char *n,Widget parent, char *msg,
		      void (*cb)(XMWidget *,
				 XtPointer, XtPointer) = NULL,
		      XtPointer cbd = NULL,
		      ArgList list = NULL, Cardinal argcount=0) :
  ...
  XMInformationDialog(const char *n, XMWidget &parent, char *msg,
		      void (*cb)(XMWidget *,
				 XtPointer, XtPointer) = NULL,
		      XtPointer cbd = NULL,
		      ArgList list = NULL, Cardinal argcount=0) :
...
class XMMessageDialog : public XMMessageBox
		   ...
		   public:
		     /*  Constructors: */
		     XMMessageDialog(const char *n,Widget parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
		     ...
		     XMMessageDialog(const char *n, XMWidget &parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
...
class XMQuestionDialog : public XMMessageBox
		   ...
		   public:
		     /*  Constructors: */
		     XMQuestionDialog(const char *n,Widget parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
		     ...
		     XMQuestionDialog(const char *n, XMWidget &parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
...
class XMQuestioner : public XMQuestionDialog {
  public:
     XMQuestioner(const char *n, Widget parent, char *msg,
		  XtPointer cbd,
		  ArgList list = NULL, Cardinal argcount = 0);
     XMQuestioner(const char *n, XMWidget &parent, char *msg,
		  XtPointer cbd,
		  ArgList list = NULL, Cardinal argcount = 0);
     ~XMQuestioner();
  protected:
...
class XMWarningDialog : public XMMessageBox
		   ...
		   public:
		     /*  Constructors: */
		     XMWarningDialog(const char *n,Widget parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
		     ...
		     XMWarningDialog(const char *n, XMWidget &parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
...
class XMWorkingDialog : public XMMessageBox
		   ...
		   public:
		     /*  Constructors: */
		     XMWorkingDialog(const char *n,Widget parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
		     ...
		     XMWorkingDialog(const char *n, XMWidget &parent, char *msg,
				   void (*cb)(XMWidget *,
					      XtPointer, XtPointer) = NULL,
				   XtPointer cbd = NULL,
				   ArgList list = NULL, Cardinal argcount=0) :
...
class XMSelection : public XMMessageBox
	 ...
	 /*
         ** Constructors and destructors:
	 */
	 XMSelection(const char *name) : XMMessageBox(name) {}
...
class XMPromptDialog : public XMSelection
	 ...
	 void GetButtons() {
       ...
       public:
	 XMPromptDialog(const char *n, Widget parent, char *prompt = NULL,
			void (*cb)(XMWidget *,
				   XtPointer, XtPointer) = NULL,
			XtPointer cbd = NULL,
			ArgList list = NULL, Cardinal argcount = 0) :
	 ...
	 XMPromptDialog(const char *n, XMWidget &parent, char *prompt = NULL,
			 void (*cb)(XMWidget *,
				    XtPointer, XtPointer) = NULL,
			 XtPointer cbd = NULL,
			 ArgList list = NULL, Cardinal argcount = 0) :
...
class XMPrompter : public XMPromptDialog {
 public:
  XMPrompter(const char *name, Widget parent, char *prompt = NULL,
	     XtPointer calldata = NULL);
  XMPrompter(const char *name, XMWidget &parent, char *prompt = NULL,
	     XtPointer calldata = NULL);
  ~XMPrompter();
...
class XMSelectionDialog : public XMSelection
      {
      public:
	 XMSelectionDialog(const char *n, Widget parent, char *prompt = NULL,
			void (*cb)(XMWidget *,
				   XtPointer, XtPointer) = NULL,
			XtPointer cbd = NULL,
			ArgList list = NULL, Cardinal argcount = 0) :
	 ...
	 XMSelectionDialog(const char *n, XMWidget &parent, char *prompt = NULL,
			 void (*cb)(XMWidget *,
				    XtPointer, XtPointer) = NULL,
			 XtPointer cbd = NULL,
			 ArgList list = NULL, Cardinal argcount = 0) :
...
{
  public:
     XMSelector(const char *n, Widget parent, char *prompt = NULL,
		XtPointer cbd = NULL,
		ArgList list = NULL, Cardinal argcount = 0);
     XMSelector(const char *n, XMWidget &parent, char *prompt = NULL,
		XtPointer cbd = NULL,
		ArgList list = NULL, Cardinal argcount = 0);
     ~XMSelector();
...
class XMFileListDialog : public XMSelection
	 ...
	 void GetButtons() {
       ...
       public:
	 XMFileListDialog(const char *n, Widget parent, char 
...
{
 public:
  XMCustomDialogBox(const char *name, XMWidget &parent, char *title,
		    ArgList l= NULL, Cardinal num_args=0);
  XMCustomDialogBox(const char *name, Widget parent, char *title,
		    ArgList l=NULL, Cardinal num_args=0);
  ~XMCustomDialogBox();
